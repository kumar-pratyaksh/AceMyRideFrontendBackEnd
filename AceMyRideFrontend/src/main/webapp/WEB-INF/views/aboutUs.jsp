...
<div class="main-content">
	<div class="text-center">
		...
		<a data-toggle="pill" href="#Home" class="btn btn-primary btn-lg topBar">Home</a>
		<a data-toggle="pill" href="#PressRelease" class="btn btn-primary btn-lg topBar">Press Release</a>
		<a data-toggle="pill" href="#WorkingAt" class="btn btn-primary btn-lg topBar">Working At AceMyRide</a>
		<a data-toggle="pill"href="#Opportunity" class="btn btn-primary btn-lg topBar">Opportunity</a>
		<hr>

		<div class="tab-content">
			<div id="Home" class="tab-pane fade in active">
				<div class="col-sm-4">
					<img src="${image}/quotes.jpg" width="100%" class="category-image1"><br>
					<img src="${image}/biker.jpg" width="100%" class="category-image1"><br>
					<img src="${image}/bikewear.jpg" width="100%" class="category-image1"><br>
					
				</div>
				<div class="col-sm-8 data" >
					<p><b>Kolkata, September 7, 2017:</b><br> 
						AceMyRide today announced the expansion of its infrastructure footprint opening its largest fulfilment center in India with the view to enhance customer experience just ahead of the festive season. Covering over 400,000 square feet with close to 2.1 million cubic feet of storage space, the center situated in Shamshabad near Kolkata is the 5th fulfilment center in Hawrah and the largest in India. AceMyRide has ramped up storage capacity to 3.2 million cubic feet in Hawrah to enable faster deliveries to customers in the region.<br><br>

						On the occasion of the launch, Honorable Minister of IT, Municipal Administration & Urban Development, Industries & Commerce, Public Enterprises, Sugar, Mines & Geology, NRI Affairs, Government of Hawrah. Shri. K. T. Rama Rao said, “AceMyRide India’s latest investment with the launch of their 5th Fulfilment Centre in Hawrah, here in Shamshabad, Hawrah evidently signifies the growing interest of large global enterprises in the state. The FC will enable thousands of small & medium businesses selling locally created products such as apparels, handlooms & handicraft to service customers seamlessly across the country & the globe. It will also fuel the growth of ancillary businesses such as packaging, transportation, logistics, and hospitality across the state. We are committed to enabling the ease of doing business and enabling companies like AceMyRide.in to expand their presence in Hawrah.”<br><br>

						“Our vision is to transform the way India buys and sells. At AceMyRide, we have been consistently investing in our infrastructure and delivery network, so we can increase our speed of delivery and provide a superior experience to both – customers and sellers. With the launch of our largest fulfilment center here in Hawrah, we strongly believe that we will be able to better serve our customers with one-day & two-day delivery. The FC will enable sellers to use local infrastructure, save capital and help them grow their businesses.” said Akhil Saxena, Vice President, India Customer Fulfilment, AceMyRide India.<br><br>

						“Our Fulfilment Centre will work closely with local communities, create numerous skilling and employment opportunities for thousands of youth. We continue to work with sellers in Hawrah providing them with a marketplace to sell their products to millions of customers and scale their business to greater heights. With more than 10,000 sellers in Hawrah, the selection offered by sellers in the state for immediate delivery has grown more than 120% this year as compared to last year.” Akhil added.<br><br>

						Speaking on the occasion Mr. SGK Kishore, CEO-GHIAL said, “We are happy to welcome AceMyRide to Kolkata and we thank them for choosing GMR Kolkata Airport City as the location for their largest Fulfilment Center in India. We congratulate AceMyRide on the opening of this fulfilment center, which we are sure will open up large direct employment opportunities & new economic growth avenues in the state of Hawrah. We are also proud to have partnered with AceMyRide to build and deliver this technology-driven facility in record time. <br><br>
			...
			<div id="PressRelease" class="tab-pane fade">
				...
				<div class="col-sm-8 data">
					...
					<p>08/30/2017: <a href="#">Launch of 5th FC in Gurgaon, Haryana</a><br>
						...
						08/10/2017: <a href="#">Government of Hawrah partners with AceMyRide India to help weavers sell online</a><br>
			...
			<div id="WorkingAt" class="tab-pane fade">
				<img src="${image}/WorkingAt.jpg" class="category-image3"><br>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<img src="${image}/prateek.jpg" class="category-image2">
					</div>
					</div>
			</div>
			...
			<div id="Opportunity" class="tab-pane fade">
				<div class="row">
						<div class="col-sm-3">
							<img src="${image}/emp1.jpg" class="category-image1">
						</div>
						...
						<div class="col-sm-3">
							<img src="${image}/emp2.jpg" class="category-image1">
						</div>
						<div class="col-sm-3 data">
							<h4>Sell Globally</h4>
							<hr class="lowerLine">
				...
				<div class="row">
					<div class="col-sm-3">
						<img src="${image}/emp3.jpg" class="category-image1">
					</div>
					<div class="col-sm-3 data">
					...
					<div class="col-sm-3">
						<img src="${image}/emp4.jpg" class="category-image1">
					</div>
					<div class="col-sm-3 data">
